...
@media print{
	...
	#modalINV1 #btn1,#modalINV1 .panel-footer ,#modalINV1 .RD-heading {
		display:none;
	}
...
<div class="content-wrapper">
    ...
    <!-- table for view all records //RD-00112 -->
...
$sql8="SELECT * FROM dkash WHERE received_by='$index' AND received_type='Teacher'";	
...
$sql9="SELECT * FROM dkash_history WHERE received_by='$index' AND received_type='Teacher'";	
...
//RD-00115 
	...
	var xhttp = new XMLHttpRequest();//RD-00116-Ajax Start
  		xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
				...
				$("#phone1" ).keydown(function(){//RD-00119-phone
    				...
    				setTimeout(function() {
						...
						if (telformat.test(afterValue) == false){
							...
							mom.append('<span id="spanPhoneUpdate" class="glyphicon glyphicon-remove form-control-feedback RD-set-color-tooltip" data-toggle="tooltip" title="Enter valid phone number" ></span>');	
				...
				$("#email1" ).keydown(function(){//RD-00119-email
    				...
    				setTimeout(function() {
						...
						if (mailformat.test(afterValue) == false){
							...
							mom.addClass('has-error has-feedback');
							mom.append('<span id="spanEmailUpdate" class="glyphicon glyphicon-remove form-control-feedback RD-set-color-tooltip" data-toggle="tooltip" title="Enter valid email address" ></span>');	
				...
				$('[type="file"]').change(function () {
					...
					var ext = $('#fileToUpload1').val().split('.').pop().toLowerCase();
						...
						if($.inArray(ext, ['png','jpg','jpeg']) == -1) {
							...
							$("#btnSubmit1").attr("disabled", true);
							$('#divPhotoUpdate1').addClass('has-error has-feedback RD-col-md-4');
							$('#divPhotoUpdate1').append('<span id="spanPhoto" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip" title="This file type is not allowed" ></span>');
							...
							if(fileSize > maxSize) {
								...
								$("#btnSubmit1").attr("disabled", true);
								$('#divPhotoUpdate1').addClass('has-error has-feedback RD-col-md-4');	
								$('#divPhotoUpdate1').append('<span id="spanPhoto" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip" title="The image size is too large" ></span>');		
								...
								$("#btnSubmit1").attr("disabled", false);	
								$('#divPhotoUpdate1').removeClass('has-error has-feedback RD-col-md-4');
								$('#spanPhoto').remove();
    	...
    	xhttp.open("GET", "../model/get_teacher.php?id=" + Id , true);//RD-00116-Ajax End											
  		xhttp.send();
	 
};

$("#form2").submit(function(e){
//RD-000098-form2 submit
	...
	if(full_name == ''){
		...
		$('#divFullNameUpdate').append('<span class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip" title="The full name is required" ></span>');
	...
	if(i_name == ''){
		...
		$('#divINameUpdate').append('<span class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip" title="The initials name is required" ></span>');
	...
	if(address == ''){
		...
		$('#divAddressUpdate').append('<span class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip" title="The address is required" ></span>');
	...
	if(full_name == '' || i_name == '' || address == '' || phone == '' || email == '' || gname == '' || gaddress == '' || gphone == '' || gemail == '' ||telformat.test(phone) == false || mailformat.test(email) == false ){
		//RD-000098- form2 validation failed
		$("#btnSubmit1").attr("disabled", true);
		e.preventDefault();
		return false;
...
<!-- Modal-Delete Confirm Popup //RD-000129 -->
	<div class="modal RD-fade " id="deleteConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  		<div class="modal-dialog">
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
      			...
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYes" class="deletebtn btn btn-danger col-sm-2 pull-right">Yes</a><!-- RD-000130 -->
...
$('body').on('click', '.confirm-delete', function (e){
    ...
    var id = $(this).data('id');
	$('#modalViewform').modal('hide');
	$('#deleteConfirm').data('id1', id).modal('show');//RD-000128
});
...
//RD-000131  
	...
	var xhttp = new XMLHttpRequest();//RD-000132-Ajax Start  

  		xhttp.onreadystatechange = function() {
			
    		if (this.readyState == 4 && this.status == 200){//RD-000134
				
				var myArray = eval( xhttp.responseText );
					
				if(myArray[0]==1){//RD-000135
					
					$("#deleteConfirm").modal('hide');	        		
					var page = myArray[1];
				
					var xhttp1 = new XMLHttpRequest();//RD-000136-Start Ajax  
						xhttp1.onreadystatechange = function(){		
				
							if (this.readyState == 4 && this.status == 200) {
										
								document.getElementById('table1').innerHTML = this.responseText;//RD-000137
								cTablePage(page);//RD-000138
								Delete_alert(myArray[0]);//RD-000139	
							
							}
								
						}
						xhttp1.open("GET", "show_teacher_table.php" , true);												
  						xhttp1.send(); //RD-000136-End Ajax
				
				}
		
				if(myArray[0]==2){//RD-000140
					
					$("#deleteConfirm").modal('hide');
					Delete_alert(myArray[0]);//RD-000141
...
<!-- Modal-View form //RD-00148 --> 
	<div class="modal RD-fade" id="modalViewform" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		<div class="modal-dialog"><!--modal-dialog -->  
           ...
           <!--RD-00151--><a href="#modalUpdateform" onClick="showModal(this)"  data-original-title="Edit this user" id="id_Edit"   data-toggle="modal" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
           <!--RD-00152--><a href="#" data-original-title="Remove this user" id="id_Delete"  data-toggle="modal" type="button" class="confirm-delete btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
...
function showModal1(Viewform){
	...
	var xhttp = new XMLHttpRequest();//RD-00149-Start Ajax  
  		xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
				//RD-00150
				var myArray1 = eval( xhttp.responseText );
...
function addSalary1(){
	...
	var xhttp = new XMLHttpRequest();//RD-00116-Ajax Start
					...
					if(status == "Total Salary"){
						...
						setTimeout(function() {
							...
							if(amount != tSalary){
								...
								$('#divAmount').append('<span id="spanAmount" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip" title="The amount is not equal to Total Salary" ></span>');
								$("#btnSubmit").attr("disabled", true);
					...
					if(status == "Advance"){
						...
						setTimeout(function() {
							...
							if(amount > maxAdvance){
								...
								$('#divAmount').removeClass('has-success has-feedback');
								$('#divAmount').addClass('has-error has-feedback');
								$('#divAmount').append('<span id="spanAmount" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip" title="The advace eka wadiy" ></span>');
								$("#btnSubmit").attr("disabled", true);
    	...
    	xhttp.open("GET", "teacher_salary_details2.php?index=" + index + "&teacher_id="+id + "&page="+page , true);//RD-00116-Ajax End											
  		xhttp.send();
...
<!-- table for view all records -->
    <section class="content" id="tSalaryhistory"> <!-- Start of table section -->
    	<div class="row" id="table2"><!--RD-000112--> 
	...
	var xhttp = new XMLHttpRequest();//RD-00105-Ajax Start  
  		xhttp.onreadystatechange = function() {
			...
			if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementById('table2').innerHTML = this.responseText;//RD-000137
	...
	var xhttp = new XMLHttpRequest();//RD-00105-Ajax Start  
  		xhttp.onreadystatechange = function() {
			...
			if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementById('salaryDetails').innerHTML = this.responseText;//RD-000137
	...
	var xhttp = new XMLHttpRequest();//RD-00105-Ajax Start  
  		xhttp.onreadystatechange = function() {
			...
			if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementById('viewInvoice').innerHTML = this.responseText;//RD-000137
