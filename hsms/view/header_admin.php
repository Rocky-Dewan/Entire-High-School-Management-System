...
<div class="wrapper">
  <header class="main-header" >
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><strong>DHS</strong></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><strong>Dewan High School </strong></span>
    </a>
...
function showNotifyEvent(event_id){
	...
	var xhttp = new XMLHttpRequest();//RD-00105-Ajax Start  
		xhttp.onreadystatechange = function() {
			...
			if (this.readyState == 4 && this.status == 200) {
				document.getElementById('showEvent2').innerHTML = this.responseText;//RD-000132
...
?> 
  ...
  <div id="showEvent2">
   ...
   <!-- //RD-000124 Modal-Delete Confirm Popup -->
	<div class="modal RD-fade" id="deleteConfirmReq" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    		...
    		<div class="modal-content">
				...
				<div class="modal-body bgColorWhite">
      			...
      			<div class="modal-footer">
					<a href="#" style='margin-left:10px;' id="btnYesReq" class="deletebtn btn btn-danger col-sm-2 pull-right">Yes</a><!-- RD-000125 -->
...
//RD-000122		
    e.preventDefault();
    var id = $(this).data('id');
	$('#deleteConfirmReq').data('id1', id).modal('show');//RD-000123
