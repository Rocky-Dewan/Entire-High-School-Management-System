...
?>   
               ...
               <!--RD-000115-td1--><td id="td1_<?php echo $row['sr_id']; ?>"><?php echo $row['g_name']; ?></td>
               <!--RD-000115-td2--><td id="td2_<?php echo $row['sr_id']; ?>"><?php echo $row['s_name']; ?></td>
               <!--RD-000115-td3--><td id="td3_<?php echo $row['sr_id']; ?>"><?php echo $row['t_name']; ?></td>
               <!--RD-000115-td4--><td id="td4_<?php echo $row['sr_id']; ?>"><?php echo $row['s_fee']; ?></td>
                            	</tr>
<?php } } ?>
                        	</tbody>
                    	</table>
