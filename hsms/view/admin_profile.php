            	...
            	<div class="panel"><!--panel bg-maroon--> 
                    ...
                    <div class="panel-body"><!--panel-body -->
                     ...
                     <div class="panel-footer text-right" id="panel_footer" >
                    	<a href="#" onClick="editMyProfile('<?php echo $index; ?>')" type="button" class="btn btn-sm btn-warning" id="btnEdit"><i class="glyphicon glyphicon-edit"></i></a><!--RD-00151-->
...
function editMyProfile(my_index){
	...
	var xhttp = new XMLHttpRequest();//RD-000131-Start Ajax  
		xhttp.onreadystatechange = function() {		
				
			if (this.readyState == 4 && this.status == 200) {
				
				document.getElementById('my_profile').innerHTML = this.responseText;//RD-000132
				...
				var xhttp1 = new XMLHttpRequest();//RD-000131-Start Ajax  
					xhttp1.onreadystatechange = function() {		
						...
						if (this.readyState == 4 && this.status == 200) {
							...
							document.getElementById("full_name1").value =myArray[1];//RD-000114
							document.getElementById("i_name1").value =myArray[2];//RD-000114
							document.getElementById("gender2").value =myArray[3];//RD-000114
							document.getElementById("address1").value =myArray[4];//RD-000114
							document.getElementById("phone1").value =myArray[5];//RD-000114
							document.getElementById("email1").value =myArray[6];//RD-000114
							document.getElementById("profile_pic1").src ="../"+myArray[7];
							document.getElementById("user_name1").innerHTML =myArray[8];//RD-000114
							document.getElementById("password1").value =myArray[9];//RD-000114
							...
							$('[type="file"]').change(function (){
								...
								if($.inArray(ext, ['png','jpg','jpeg']) == -1) {
									...
									$('#divPhoto').append('<span id="spanPhoto" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip" title="The file type is not allowed" ></span>');
									...
									if(fileSize > maxSize) {
										...
										$("#btnUpdate").attr("disabled", true);
										$('#divPhoto').addClass('has-error has-feedback');
										$('#divPhoto').append('<span id="spanPhoto1" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip" title="The file size is too large" ></span>');		
							...
							$("form").submit(function (e){
								...
								if(full_name == ''){
									...
									$('#tdFullName2').append('<span id="spanFullName" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip"    title="The full name is required" ></span>');	
								...
								if(i_name == ''){
									...
									$('#tdIName2').append('<span id="spanIName" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip"    title="The intial name is required" ></span>');	
								...
								if(address == ''){
									...
									$('#tdAddress2').append('<span id="spanAddress" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip"   title="The address is required" ></span>');	
								...
								if(phone == ''){
									...
									$('#tdPhone2').append('<span id="spanPhone" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip"   title="The phone number is required" ></span>');	
									...
									if (telformat.test(phone) == false){ 
										//RD-00104-phone
										$('#tdPhone2').addClass('has-error has-feedback');
										$('#tdPhone2').append('<span id="spanPhone" class="glyphicon glyphicon-remove form-control-feedback RD-set-color-tooltip" data-toggle="tooltip"    title="Enter valid phone number" ></span>');
								...
								if(email == ''){
									...
									$('#tdEmail2').append('<span id="spanEmail" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip"   title="The email address is required" ></span>');	
									...
									if (mailformat.test(email) == false){ 
										//RD-00108-email
										$('#tdEmail2').addClass('has-error has-feedback');
										$('#tdEmail2').append('<span id="spanEmail" class="glyphicon glyphicon-remove form-control-feedback RD-set-color-tooltip" data-toggle="tooltip"    title="Enter valid email address" ></span>');
								...
								if(password == ''){
									...
									$('#tdPassword2').append('<span id="spanPassword" class="glyphicon glyphicon-remove form-control-feedback RD-set-width-tooltip" data-toggle="tooltip"   title="The password is required" ></span>');	
