...
?>
        ...
        function ShowEvents(status, my_index, my_type) {
            ...
            var d = new Date(); //new Date('2024','08','25');
            ...
            var xhttp = new XMLHttpRequest(); //RD-250-Ajax Start  
            xhttp.onreadystatechange = function() {

                if (this.readyState == 4 && this.status == 200) {
                    //MSK-00107 
                    document.getElementById('row').innerHTML = this.responseText; //RD-250
        ...
        function showEvent(event_id) {
            ...
            xhttp.onreadystatechange = function() {
                ...
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById('showEvent').innerHTML = this.responseText; //RD-250
