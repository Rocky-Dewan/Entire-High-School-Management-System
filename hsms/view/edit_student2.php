...
.RD-00102-email-set-width-tooltip + .tooltip > .tooltip-inner { 
  
     min-width:180px;
}
.RD-00102-email-set-color-tooltip + .tooltip > .tooltip-inner { 
...
#modalINV #btn1,#modalINV .panel-footer ,#modalINV .RD-00102-email-heading {
		display:none;
...
$('#fileToUpload').change(function(){
	...
	if($.inArray(ext, ['png','jpg','jpeg']) == -1){
		//RD-00102-email-00099
		output.src="../uploads/error.png";
		$("#btnSubmit").attr("disabled", true);
		$('#divPhoto').addClass('has-error');
		$('#divPhoto1').addClass('has-feedback');
		$('#divPhoto1').append('<span id="spanPhoto" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"                                title="The file type is not allowed" ></span>');
		
	}else{

		if(fileSize > maxSize) {
			//RD-00102-email-00100
			output.src="../uploads/error.png";
			$("#btnSubmit").attr("disabled", true);
			$('#divPhoto').addClass('has-error');
			$('#divPhoto1').addClass('has-feedback');	
			$('#divPhoto1').append('<span id="spanPhoto" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip" title="The file size is too large" ></span>');		
			
					
		}else{
			// RD-00102-email-00101
			output.src = URL.createObjectURL(this.files[0]);	
			$("#btnSubmit").attr("disabled", false);	
			$('#divPhoto').removeClass('has-error');
			$('#spanPhoto').remove();// RD-00102-email-00101
...
$('#g_fileToUpload').change(function(){
	...
	if($.inArray(ext, ['png','jpg','jpeg']) == -1){
		...
		$('#divGPhoto1').append('<span id="spanGPhoto" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"                                title="The file type is not allowed" ></span>');
		...
		if(fileSize > maxSize) {
			...
			$('#divGPhoto').addClass('has-error');
			$('#divGPhoto1').addClass('has-feedback');	
			$('#divGPhoto1').append('<span id="spanGPhoto" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip" title="The file size is too large" ></span>');		
			...
			$('#spanGPhoto').remove();// RD-00102-email-00101
...
$("form").submit(function (e){
	//RD-00102-email-000098-form submit
	...
	if(index_number == ''){
		//RD-00102-email-00102-index_number 
		$("#btnSubmit").attr("disabled", true);
		$('#divIndexNumber').addClass('has-error has-feedback');
		$('#divIndexNumber').append('<span id="spanIndexNumber" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" 									 data-toggle="tooltip" title="The index number is required" ></span>');	
			
		$("#index_number").keydown(function(){
			//RD-00102-email-00103-index_number 
			$("#btnSubmit").attr("disabled", false);	
	...
	if(g_index_number == ''){
		...
		$('#divGIndexNumber').append('<span id="spanGIndexNumber" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" 									 data-toggle="tooltip" title="The index number is required" ></span>');	
	...
	if(full_name == ''){
		//RD-00102-email-00102-full_name 
		$("#btnSubmit").attr("disabled", true);
		$('#divFullName').addClass('has-error has-feedback');
		$('#divFullName').append('<span id="spanFullName" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The full name is required" ></span>');	
		
		$("#full_name").keydown(function(){
			//RD-00102-email-00103-full_name 
			$("#btnSubmit").attr("disabled", false);	
	...
	if(g_full_name == ''){
		...
		$('#divGFullName').append('<span id="spanGFullName" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The full name is required" ></span>');	
	...
	if(i_name == ''){
		//RD-00102-email-00102-i_name
		$("#btnSubmit").attr("disabled", true);
		$('#divIName').addClass('has-error has-feedback');
		$('#divIName').append('<span id="spanIName" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The initials name is required" ></span>');	
		
		$( "#i_name" ).keydown(function() {
			//RD-00102-email-00103-i_name
			$("#btnSubmit").attr("disabled", false);	
	...
	if(g_i_name == ''){
		...
		$('#divGIName').append('<span id="spanGIName" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The initials name is required" ></span>');	
	...
	if(address == ''){
		//RD-00102-email-00102-address
		$("#btnSubmit").attr("disabled", true);
		$('#divAddress').addClass('has-error has-feedback');
		$('#divAddress').append('<span id="spanAddress" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The address is required" ></span>');	
		
		$("#address").keydown(function() {
			//RD-00102-email-00103-address
			$("#btnSubmit").attr("disabled", false);	
	...
	if(g_address == ''){
		...
		$('#divGAddress').append('<span id="spanGAddress" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The address is required" ></span>');	
	...
	if(gender == 'Select Gender'){
		//RD-00102-email-00102-gender
		$("#btnSubmit").attr("disabled", true);
		$('#divGender').addClass('has-error ');
		$('#divGender1').addClass('has-error has-feedback');
		$('#divGender1').append('<span id="spanGender" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The gender is required" ></span>');	
		
		$("#gender").change(function() {
			//RD-00102-email-00103-gender
			$("#btnSubmit").attr("disabled", false);	
	...
	if(g_gender == 'Select Gender'){
		...
		$('#divGGender1').append('<span id="spanGGender" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The gender is required" ></span>');	
	...
	if(b_date == ''){
		...
		$('#divDOB1').append('<span id="spanDOB" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The date of birth is required" ></span>');	
	...
	if(g_b_date == ''){
		...
		$('#divGDOB1').append('<span id="spanGDOB" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The date of birth is required" ></span>');	
	...
	if(email == ''){
		//RD-00102-email-00102-email	
		$('#divEmail').addClass('has-error has-feedback');
		$('#divEmail1').append('<span id="spanEmail" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The email address is required" ></span>');	
		
		$("#email").keydown(function() {
			//RD-00102-email-00103-email
			$("#btnSubmit").attr("disabled", false);	
		...
		if (mailformat.test(email) == false){ 
			//RD-00102-email-00108-email
			$('#divEmail').addClass('has-error has-feedback');
			$('#divEmail1').append('<span id="spanEmail" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-color-tooltip" data-toggle="tooltip"    title="Enter valid email address" ></span>');
			
			$("#email").keydown(function(){
				//RD-00102-email-00109-email
	...
	if(g_email == ''){
		...
		$('#divGEmail1').append('<span id="spanGEmail" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The email address is required" ></span>');	
		...
		if (mailformat.test(g_email) == false){ 
			//RD-00102-email-00108-email
			$('#divGEmail').addClass('has-error has-feedback');
			$('#divGEmail1').append('<span id="spanGEmail" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-color-tooltip" data-toggle="tooltip"    title="Enter valid email address" ></span>');
	...
	if(phone == ''){
		//RD-00102-email-00102-phone
		$('#divPhone1').addClass('has-error has-feedback');
		$('#divPhone1').append('<span id="spanPhone" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The phone number is required" ></span>');	
				
		$("#phone").keydown(function() {
			//RD-00102-email-00103-phone
			$("#btnSubmit").attr("disabled", false);	
	...
	if(g_phone == ''){
		...
		$('#divGPhone1').append('<span id="spanGPhone" class="glyphicon glyphicon-remove form-control-feedback RD-00102-email-set-width-tooltip" data-toggle="tooltip"    title="The phone number is required" ></span>');	
	...
	if(index_number == '' || g_index_number == '' || full_name == '' || g_full_name == '' || i_name == '' || g_i_name == '' || address == '' || g_address == '' || gender == 'Select Gender' || g_gender == 'Select Gender' || b_date == '' || g_b_date == '' || email == '' || mailformat.test(email) == false || g_email == '' || mailformat.test(g_email) == false || phone == ''  || g_phone == '' ) {
		...
		//RD-00102-email-000098- form validation failed
		$("#btnSubmit").attr("disabled", true);
		e.preventDefault();
		return false;
